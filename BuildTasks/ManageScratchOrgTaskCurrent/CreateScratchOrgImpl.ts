...
export default class CreateScratchOrgImpl {
  ...
  public constructor(private working_directory:string,private config_file_path: string, private devhub: string,private alias: string,private daysToMaintain:number) {}
